...
public class DespegarTestTest {
  ...
  public void ValidarViajeDespegar() throws Exception{
	  ...
	  WebElement Inicio = driver.findElement(By.xpath("//div[@class='sbox5-floating-tooltip sbox5-floating-tooltip-opened']//div[@class='sbox5-monthgrid'][@data-month='2022-02']//div[@class='sbox5-monthgrid-datenumber-number'][text()='26']"));
	  Inicio.click();
	  Thread.sleep(1000);
	  System.out.println("Eligiendo fecha de salida");
	  WebElement Salida = driver.findElement(By.xpath("//*[@class='sbox5-floating-tooltip sbox5-floating-tooltip-opened']//*[@class='sbox5-monthgrid'][@data-month='2022-03']//*[@class='sbox5-monthgrid-datenumber-number'][text()='6']"));
	  Salida.click();
	  Thread.sleep(1000);
	  ...
	  Busqueda.click();
	  Thread.sleep(5000);
	  WebElement Hotel = driver.findElement(By.xpath("//*[@class='accommodation-name-wrapper']//*[@class='accommodation-name -eva-3-ellipsis'][text()='Torre Colon']"));
...
//WebElement primerDestino = driver.findElement(By.xpath("//*[@class='ac-group-container']//*[@class='history-item__aside']/*[@class='history-item__title'][text()='Concepcion del Uruguay, Entre Ríos, Argentina']"));
//primerDestino.sendKeys(Keys.ENTER);
//*[@class='ac-group-container']//*[@class='item-text']
//destino.sendKeys(Keys.chord(Keys.CONTROL,Keys.ARROW_DOWN));
//destino.sendKeys(Keys.ENTER);
// WebElement Adultos = driver.findElement(By.xpath("//*[@class='stepper__room__row']/*[@class='stepper__room__row__stepper__contaer']/*[@class='sbox5-3-steppers -md']/*[@class='steppers-icon-right stepper__icon']/*['svg-plus-3xwvNFB']"));
//WebElement Adultos2 = driver.findElement(By.xpath("//*[@class='stepper__room__row__stepper__contaer']/*[@class='sbox5-3-steppers -md']/*[@class='steppers-icon-right stepper__icon']//*[@id='svg-plus-3xwvNFB']/*[@id='svg-plus-3EC1PNp']/*[@id='svg-plus-uJ24xqk']"));
